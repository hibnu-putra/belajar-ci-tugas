<header id="header" class="header fixed-top d-flex align-items-center">
    ...
    </div><?php if (session()->has('diskon') && session()->get('diskon') > 0) : ?>
    <div class="ms-4">
        <span class="badge bg-success"><i class="bi bi-tag-fill"></i> Hari ini diskon <?= number_to_currency(session()->get('diskon'), 'IDR') ?></span>
    </div>
    <?php endif; ?>
...
Dengan mengganti seluruh isi file `header.php`, Anda memastikan tidak ada lagi sisa kode dari `v_profile.php` di dalamnya. Error seharusnya sudah hilang sekarang.